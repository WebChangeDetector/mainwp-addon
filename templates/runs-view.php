...
if ('' === $token) {
    $settings_url = esc_url(admin_url('admin.php?page=' . WCD_MainWP_Bootstrap::settingsPageSlug()));
    ?>
    <div class="wcd-runs">
        <div class="ui info message"><p>
            ...
            printf(
                ...
                $settings_url // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- esc_url above.
            );
            ?>
        </p></div>
    </div>
...
$status_options  = WCD_MainWP_Runs_View::statusOptions();
$source_options  = WCD_MainWP_Runs_View::sourceOptions();
$website_options = WCD_MainWP_Runs_View::websiteOptions();
